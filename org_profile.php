            ...
            <section class="org-card org-profile-card">
                ...
                <div class="org-profile-top">
                    ...
                    <div class="org-profile-meta">
                        ...
                        <h2>
                            <?= htmlspecialchars($organizer['nama_organisasi']) ?>
                        </h2>
                    ...
                    <div class="org-form-grid">
                        ...
                        <div class="org-form-group">
                            ...
                            <input
                                ...
                                class="org-input"
                                value="<?= htmlspecialchars($organizer['nama_organisasi']) ?>"
                            >
                        ...
                        <div class="org-form-group">
                            ...
                            <input
                                ...
                                name="whatsapp"
                                class="org-input"
                                value="<?= htmlspecialchars($organizer['whatsapp']) ?>"
                            >
