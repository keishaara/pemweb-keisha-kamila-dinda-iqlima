...
if (($event['status'] ?? '') === 'locked') {
    die("<div class='denied-container'><h2>🚫 Akses Ditolak</h2><p>Acara ini sedang ditangguhkan oleh Admin dan tidak dapat diakses untuk sementara waktu.</p><br><a href='user_dashboard.php' class='btn-return-dashboard'>Kembali ke Dashboard</a></div>");
}
